...
define( 'GD_MEMCACHE_SOCK',    'unix:///var/chroot/var/tmp/moxi/c1e.b7a.myftpupload.com.sock' );
#define( 'GD_MEMCACHE_SOCK',    'localhost:11211' );
define( 'WP_CACHE_KEY_SALT',   'pzrghjzg72a7vtw68ddr' );
define( 'GD_SITE_KEY',         '#SITEKEY#' );
define( 'GD_BATCACHE_MAX_AGE', 300 );
define( 'GD_BATCACHE_HITS',    2 );
define( 'GD_BATCACHE_SECONDS', 120 );
define( 'GD_VARNISH_SERVERS', '184.168.224.117,184.168.224.131,184.168.193.50' );
