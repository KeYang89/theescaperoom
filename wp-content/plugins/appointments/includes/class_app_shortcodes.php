...
class App_Shortcode_WeeklySchedule extends App_Shortcode {
	public function __construct () {
		$this->_defaults = array(
			'title' => array(
				'value' => __('<h3>START - END</h3>', 'appointments'),
...
class App_Shortcode_ServiceProviders extends App_Shortcode {
	public function __construct () {
		$this->_defaults = array(
			'select' => array(
				'value' => __('Select a Room', 'appointments'),
				'help' => __('Text above the select menu. Default: "Please select a service"', 'appointments'),
				'example' => __('Select a Room', 'appointments'),
			),
			'empty_option' => array(
...
class App_Shortcode_Confirmation extends App_Shortcode {
	public function __construct () {
		$this->_defaults = array(
			'title' => array(
				'value' => __('<h3>PLEASE CHECK YOUR BOOKING DETAILS</h3>', 'appointments'),
				'help' => __('Text above fields. Default: "PLEASE CHECK YOUR BOOKING DETAILS"', 'appointments'),
				'example' => __('PLEASE CHECK YOUR BOOKING DETAILS', 'appointments'),
			),
			'button_text' => array(
				'value' => __('Buy Now', 'appointments'),
				'help' => __('Text of the button that asks client to confirm the appointment. Default: "Buy Now"', 'appointments'),
				'example' => __('Buy Now', 'appointments'),
			),
			'confirm_text' => array(
