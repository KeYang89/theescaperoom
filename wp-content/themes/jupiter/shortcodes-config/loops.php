...
vc_map(array(
    ...
    "category" => __('Loops', 'mk_framework'),
    'description' => __( 'Shows blog posts in carousel.', 'js_composer' ),
    "params" => array(
        array(
...
vc_map(array(
    ...
    "category" => __('Loops', 'mk_framework'),
    'description' => __( 'Showcase your portfolio and blog posts.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "multiselect",
            "heading" => __("Select Specific Categories", "mk_framework"),
...
vc_map(array(
    ...
    "category" => __('Loops', 'mk_framework'),
    'description' => __( 'Shows Portfolio loop in carousel.', 'js_composer' ),
    "params" => array(
        array(
            "heading" => __("Style", 'mk_framework'),
...
vc_map(array(
   ...
   'icon' => 'icon-mk-news vc_mk_element-icon',
    "category" => __('Loops', 'mk_framework'),
    'description' => __( 'News Loop is here.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "range",
...
vc_map(array(
    ...
    "category" => __('Loops', 'mk_framework'),
    'description' => __( 'Shows FAQ posts in multiple styles.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "dropdown",
            "heading" => __("Style", "mk_framework"),
