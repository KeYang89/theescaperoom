...
vc_map(array(
    ...
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Swipe enabled slideshow.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "attach_images",
            "heading" => __("Add Images", "mk_framework"),
...
vc_map(array(
    ...
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Fullwdith image slider.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "range",
...
vc_map(array(
    ...
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Slider inside laptop frame', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
...
vc_map(array(
    ...
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Slider inside LCD frame', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Title", "mk_framework"),
...
vc_map(array(
    ...
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Flexslider with captions.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __("Title", "mk_framework"),
...
vc_map(array(
    ...
    'icon' => '',
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'Banner Builder.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "multiselect",
            "heading" => __("Select specific slides", "mk_framework"),
...
vc_map(array(
    ...
    'icon' => '',
    "category" => __('Slideshows', 'mk_framework'),
    'description' => __( 'iCarousel.', 'js_composer' ),
    "params" => array(
        array(
            "type" => "multiselect",
            "heading" => __("Select specific slides", "mk_framework"),
