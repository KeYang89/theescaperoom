...
function mk_jupiter_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'source' => THEME_DIR . '/plugins/envato-wordpress-toolkit-master.zip',
...
/**
    ...
    $config = array(
        ...
        'strings'      => array(
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'mk_framework' ), // %s = dashboard link.
