module.exports = function(grunt) {
  ...
  var admin_scripts = [
    "../framework/admin/assets/js/theme-backend-scripts.js"
  ];
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      admin_scripts: {
        src: admin_scripts,
        dest: "../framework/admin/assets/js/theme-backend-scripts.js"
      },
    ...
    watch: {
      ...
      //      },
      liveDevelop: {
        files: ['src/*.js', 'plugins/*.js', 'vendors.js'],
        tasks: ['build'],
        options: {
          spawn: false
        }
      ...
      adminDevelop: {
        files: ['theme-backend-scripts.js'],
        tasks: ['build'],
        options: {
          spawn: false
        }
    ...
    uglify: {
      ...
      admin_scripts: {
        ...
        files: {
          '../framework/admin/assets/js/min/theme-backend-scripts-ck.js': ['../framework/admin/assets/js/theme-backend-scripts.js']
        }
      }
    },
